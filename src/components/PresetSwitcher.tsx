...
export function PresetSwitcher({ activePresetId, onSelect }: PresetSwitcherProps) {
  return (
      ...
      {PRESETS.map((preset) => {
        ...
        return (
          <button
            ...
            className={`min-h-8 whitespace-nowrap rounded-lg px-2.5 text-xs font-semibold transition ${
              isActive
