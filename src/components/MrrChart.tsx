    ...
    <section className="overflow-hidden rounded-none bg-[#ffffff] shadow-[0_10px_26px_rgba(23,33,29,0.09)]">
      <div className="flex items-center justify-between border-b border-[#e4e3dc] px-4 py-3.5">
        <div className="flex items-center gap-2">
          <Activity aria-hidden="true" className="text-[#8a6a26]" size={17} strokeWidth={1.9} />
          <h2 className="text-sm font-semibold tracking-[-0.01em]">Monthly recurring revenue</h2>
        </div>
        <span className="text-[10px] font-semibold uppercase tracking-[0.1em] text-[#8b928c]">24-month view</span>
      </div>
      <div
